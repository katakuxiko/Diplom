...
func NewHandler(rag *service.RAGService, llm *service.LLMClient, chunkService *service.ChunkService, chatSettings *service.ChatSettingsService, chatHistoryRepo *repository.ChatHistoryRepository, messageRepo *repository.MessageRepository) *Handler {
	return &Handler{rag: rag, llm: llm, chunkService: chunkService, chatSettings: chatSettings, chatHistoryRepo: chatHistoryRepo, messageRepo: messageRepo}
}
